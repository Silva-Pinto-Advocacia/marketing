# -*- coding: utf-8 -*-
"""Contrato de honorários — IR sobre a GRAM, modalidade ENTRADA + ÊXITO.
...
BLOCOS = [
    ...
    ("P", [("1. ", 1), ("Honorário inicial de R$ 1.999,00 (mil novecentos e noventa e nove reais), a ser "
                        "pago mediante {{FORMA DE PAGAMENTO}}, em {{NÚMERO DE PARCELAS}} parcela(s), com "
                        "vencimento da primeira em {{DATA DO PAGAMENTO OU DA PARCELA}}.", 0)]),
    ("P", [("2. ", 1), ("Não haverá mensalidade durante o processo. Se for concedida e efetivamente "
                        "implementada decisão judicial suspendendo a retenção do IR sobre a GRAM, o valor "
                        "que deixar de ser retido permanecerá com o CONTRATANTE, sem pagamento mensal "
                        "adicional ao CONTRATADO.", 0)]),
    ("P", [("3. ", 1), ("Havendo recuperação de valores, serão devidos honorários de êxito de 30% (trinta "
    ...
    ("P", [("4. ", 1), ("Não havendo recuperação de valores, não haverá honorários de êxito. O honorário "
                        "inicial remunera a análise, o ajuizamento e o acompanhamento da demanda e não "
                        "será devolvido em razão de resultado desfavorável.", 0)]),
    ("P", [("5. ", 1), ("Não há garantia de tutela de urgência, resultado, prazo ou valor. Se a suspensão "
    ...
    ("P", [("6. ", 1), ("Eventual condenação em honorários de sucumbência pertence ao advogado e não "
    ...
    ("P", [("O contratante declara estar ciente, de forma expressa, de que ", 0),
           ...
           (". Revogada ou reformada a decisão, o Estado poderá restabelecer o desconto e cobrar os "
            "valores que deixaram de ser retidos e permaneceram com o contratante, com os acréscimos "
            "legais cabíveis.", 0)]),

    # ---------------------------------------------------- 7 obrig contratado
    ("T", "7 | Obrigações do contratado"),
    ("S", "Quais são os meus deveres?"),
    ("P", [("Prestação dos serviços necessários à consecução do objeto, incluindo análise documental, "
            "elaboração e protocolo das peças processuais, acompanhamento da demanda, comparecimento a "
            "audiências e demais atos judiciais, atuação recursal e, havendo decisão favorável, "
            "acompanhamento do cumprimento ou execução do julgado, nas instâncias necessárias.", 0)]),
    ...
    ("L", "Informar imediatamente o restabelecimento da retenção, bem como qualquer alteração de lotação, passagem à inatividade, transferência ou exoneração;"),
    ...
    ("P", [("É indeterminado o prazo de duração deste Contrato, iniciado com a sua assinatura e "
            "subordinado à conclusão dos serviços contratados, incluindo, se houver crédito a executar, "
            "o respectivo cumprimento ou execução, salvo rescisão anterior.", 0)]),

    # --------------------------------------------------------- 10 rescisão
    ("T", "10 | Se você quiser cancelar"),
    ("S", "O que acontece se você cancelar sem justificativa"),
    ("P", [("Em caso de rescisão unilateral e injustificada pelo CONTRATANTE, o honorário inicial já pago "
            "não será restituído e permanecem devidos os valores vencidos até a data da rescisão. Se "
            "houver proveito econômico posteriormente obtido em decorrência dos atos já praticados pelo "
            "CONTRATADO, serão devidos honorários proporcionais ao trabalho realizado, sem prejuízo do "
            "êxito quando juridicamente aplicável.", 0)]),
...
n = gera("Contrato_Honorarios_GRAM_Entrada.docx")
print(f"Contrato_Honorarios_GRAM_Entrada.docx: {n} parágrafos, {os.path.getsize('Contrato_Honorarios_GRAM_Entrada.docx')} bytes")
